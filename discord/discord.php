...
use Akeeba\SocialLogin\Discord\OAuth as DiscordOAuth;
use Akeeba\SocialLogin\Discord\UserQuery;
...
/**
 * Akeeba Social Login plugin for Discord integration
 */
class plgSocialloginDiscord extends AbstractPlugin
{
	/**
	...
	public function __construct($subject, array $config = array())
	{
		...
		JLoader::registerNamespace('Akeeba\\SocialLogin\\Discord', __DIR__ . '/Discord', false, false, 'psr4');

		// Per-plugin customization
		$this->buttonImage = 'plg_sociallogin_discord/discord.png';
	}

	/**
	 * Returns a DiscordOAuth object
	 *
	 * @return  DiscordOAuth
	 *
	 * @throws  Exception
	...
	protected function getConnector()
	{
		if (is_null($this->connector))
		{
			...
			$this->connector = new DiscordOAuth($options, $httpClient, $app->input, $app);
	 ...
	 */
	 protected function mapSocialProfileToUserData(array $socialProfile)
 	{
 		...
 		$userData->name     = isset($socialProfile['username']) ? $socialProfile['username'] : '';
	...
	/**
	 * Processes the authentication callback from Discord.
	 *
